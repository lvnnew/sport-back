...
export type AutoDefinableMessageTemplatePart = MutationCreateMessageTemplateArgs;
export type MutationCreateMessageTemplateArgsWithAutoDefinable = AutoDefinableMessageTemplatePart & MutationCreateMessageTemplateArgs;
export type MutationCreateMessageTemplateArgsWithoutAutoDefinable = Omit<MutationCreateMessageTemplateArgs, AutoDefinableMessageTemplateKeys>;

export type StrictUpdateMessageTemplateArgs = DefinedFieldsInRecord<MutationUpdateMessageTemplateArgs, AutoDefinableMessageTemplateKeys>;
export type StrictCreateMessageTemplateArgs = DefinedFieldsInRecord<MutationCreateMessageTemplateArgs, AutoDefinableMessageTemplateKeys>;
...
export type MessageTemplatesService = BaseMessageTemplatesMethods
  ...
  & HooksAddType<
    MessageTemplate,
    QueryAllMessageTemplatesArgs,
    MutationCreateMessageTemplateArgsWithAutoDefinable,
    MutationUpdateMessageTemplateArgs,
    MutationRemoveMessageTemplateArgs,
...
export const getMessageTemplatesService = (ctx: Context) => {
  ...
  const create = async (
    ...
    const cleared = byUser ?
      R.omit(forbiddenForUserFields, data) as MutationCreateMessageTemplateArgsWithoutAutoDefinable :
      data;

    // augment data by default fields
    const augmented: MutationCreateMessageTemplateArgsWithAutoDefinable = R.mergeLeft(cleared, defaultPart);
  ...
  const createMany = async (
    ...
    // augment data by default fields
    const augmentedData =
      clearedData.map(data => R.mergeLeft(data, defaultPart) as MutationCreateMessageTemplateArgsWithAutoDefinable);
