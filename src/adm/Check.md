...
```sh
curl 'http://agr-ep.stage.apps.stage01.making.ventures/app-api/register' \
...
Adm register
```sh
curl 'http://agr-ep.stage.apps.stage01.making.ventures/adm-api/register' \
  -H 'content-type: application/json' \
...
Adm login
```sh
curl 'http://agr-ep.stage.apps.stage01.making.ventures/adm-api/login' \
  -H 'content-type: application/json' \
