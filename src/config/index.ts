...
const envConfig = {
  ...
  s3AccessKeyId: utils.getStringConfig('s3.accessKeyId', false),
  s3BucketEmailFiles: utils.getStringConfig('s3.bucket.emailFiles', false),
  s3BucketTmpFilesToDownload: utils.getStringConfig('s3.bucket.tmpFilesToDownload', false),
  s3SecretAccessKey: utils.getStringConfig('s3.secretAccessKey', false),
