...
const envConfig = {
  ...
  esCloudId: getFromNconf('es.cloudId'),
  esNode: getFromNconf('es.node'),
  esPassword: getFromNconf('es.password'),
  esTlsRejectUnauthorized: getFromNconf('es.tls.rejectUnauthorized'),
  esUsername: getFromNconf('es.username'),
