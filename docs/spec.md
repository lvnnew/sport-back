...
* [Каталоги](#каталоги)
  ...
  * [Отчеты для родителей](#отчеты-для-родителей)
...
| calculateFoul             | Участвует в расчете Фол                   | bool       | Не обязательное |                                                                    |
| calculateOffside          | Участвует в расчете Оффсайд               | bool       | Не обязательное |                                                                    |

### Предопределенные элементы

| id          | title            | points | eventTypeCategoryId | order | showInTranslationMode | needForSecondPlayer | dependsOnPoint | redCard | yellowCard | calculateBlock | calculateTakeaway | calculateSelection | calculateInterseption | calculateGuardian | calculatePositionError | calculateGrossError | calculatePositiveDribling | calculateNegativeDribling | calculatePositiveSgm | calculateNegativeSgm | calculatePositiveRgm | calculateNegativeRgm | calculateLosses | calculateGegenPressing | calculatePressing | calculateSaveBall | calculatePositiveTransfer | calculateNegativeTransfer | calculateHit | calculateHitTarget | calculateCorner | calculateFoul | calculateOffside |
| ----------- | ---------------- | ------ | ------------------- | ----- | --------------------- | ------------------- | -------------- | ------- | ---------- | -------------- | ----------------- | ------------------ | --------------------- | ----------------- | ---------------------- | ------------------- | ------------------------- | ------------------------- | -------------------- | -------------------- | -------------------- | -------------------- | --------------- | ---------------------- | ----------------- | ----------------- | ------------------------- | ------------------------- | ------------ | ------------------ | --------------- | ------------- | ---------------- |
| playerEnter | Выход на поле    | 10     |                     |       |                       | false               | false          | false   | false      |                |                   |                    |                       |                   |                        |                     |                           |                           |                      |                      |                      |                      |                 |                        |                   |                   |                           |                           |              |                    |                 |               |                  |
| yellowCard  | Желтая карточка  | 15     |                     |       |                       | false               | false          | false   | true       |                |                   |                    |                       |                   |                        |                     |                           |                           |                      |                      |                      |                      |                 |                        |                   |                   |                           |                           |              |                    |                 |               |                  |
| redCard     | Красная карточка | 7      |                     |       |                       | false               | false          | true    | false      |                |                   |                    |                       |                   |                        |                     |                           |                           |                      |                      |                      |                      |                 |                        |                   |                   |                           |                           |              |                    |                 |               |                  |
| replacement | Замена           | 4      |                     |       |                       | true                | false          | false   | false      |                |                   |                    |                       |                   |                        |                     |                           |                           |                      |                      |                      |                      |                 |                        |                   |                   |                           |                           |              |                    |                 |               |                  |
| swap        | Перестановка     | 20     |                     |       |                       | false               |                |         |            |                |                   |                    |                       |                   |                        |                     |                           |                           |                      |                      |                      |                      |                 |                        |                   |                   |                           |                           |              |                    |                 |               |                  |
...
* catalogs.glossaries.title.plural
...
Нужен для: Дочерняя сущность для матча
...
* `firstTeamId`, `secondTeamId`, `matchDate`, `matchTime`
...
### playerForCompetitionTeams.create
...
| id                     | Ид                     | string     | Обязательное |                                                                  |
| title                  | Название               | string     | Обязательное |                                                                  |
| shortTitle             | Сокращенное название   | string     | Обязательное |                                                                  |
| playerAggregatedRoleId | Агрегированная позиция | string     | Обязательное | ссылается на [`Агрегированные позиции`](#агрегированные-позиции) |

### Предопределенные элементы

| id                             | title                              | shortTitle | playerAggregatedRoleId |
| ------------------------------ | ---------------------------------- | ---------- | ---------------------- |
| goalkeeper                     | Вратарь                            | ВР         | goalkeeperAggregated   |
| leftBack                       | Левый защитник                     | ЛЗ         | defenderAggregated     |
| leftCenterBack                 | Левый центральный защитник         | ЛЦЗ        | defenderAggregated     |
| Centerdef                      | Центральный защитник               | ЦЗ         | defenderAggregated     |
| rightCenterBack                | Правый центральный защитник        | ПЦЗ        | defenderAggregated     |
| rightBack                      | Правый защитник                    | ПЗ         | defenderAggregated     |
| leftMidfielder                 | Левый фулбек                       | ЛФБ        | midfielderAggregated   |
| leftCentralMidfielder          | Левый опорный полузащитник         | ЛОПЗ       | midfielderAggregated   |
| centerMidfielder               | Опорный полузащитник               | ОПЗ        | midfielderAggregated   |
| rightCentralMidfielder         | Правый опорный полузащитник        | ПОПЗ       | midfielderAggregated   |
| rightMidfielder                | Правый фулбек                      | ПФБ        | midfielderAggregated   |
| leftDefensiveMidfielder        | Левый полузащитник                 | ЛПЗ        | midfielderAggregated   |
| leftCenterDefensiveMidfielder  | Левый атакующий полузащитник       | ЛАТПЗ      | midfielderAggregated   |
| defensiveMidfielder            | Центральный атакующий полузащитник | ЦАПЗ       | midfielderAggregated   |
| rightCenterDefensiveMidfielder | Правый атакующий полузащитник      | ПАПЗ       | midfielderAggregated   |
| rightDefensiveMidfielder       | Правый полузащитник                | ППЗ        | midfielderAggregated   |
| leftWinger                     | Левый нападающий                   | ЛН         | attackAggregated       |
| leftCenterWinger               | Левый центральный нападающий       | ЛЦН        | attackAggregated       |
| centerForward                  | Центральный нападающий             | ЦН         | attackAggregated       |
| rightCenterWinger              | Правый центральный нападающий      | ПЦН        | attackAggregated       |
| rightWinger                    | Правый нападающий                  | ПН         | attackAggregated       |
...
* catalogs.playerRoles.title.plural
* catalogs.playerRoles.title.singular
* catalogs.playerRoles.fields.search
* catalogs.playerRoles.fields.title
* catalogs.playerRoles.fields.shortTitle

## Игроки

`players`

Нужен для: Таблица игроков

На сущность ссылаются: [`История ролей игроков`](#история-ролей-игроков), [`Рейтинги игроков команд на турнирах`](#рейтинги-игроков-команд-на-турнирах), [`Списки игроков команд на турнире `](#списки-игроков-команд-на-турнире-), [`Заявки игроков на матч`](#заявки-игроков-на-матч), [`Игроки заявки`](#игроки-заявки), [`Рейтинги игроков на матчах`](#рейтинги-игроков-на-матчах), [`Отчеты для родителей`](#отчеты-для-родителей), [`Игроки команд`](#игроки-команд), [`События`](#события)
...
| patronymic                    | Отчество                                     | string     | Не обязательное |                                                                  |
| title                         | Название                                     | string     | Обязательное    |                                                                  |
| playerName                    | Игрок                                        | string     | Не обязательное |                                                                  |
| number                        | Номер игрока                                 | int        | Обязательное    |                                                                  |
| dateOfBirth                   | Дата рождения                                | date       | Обязательное    |                                                                  |
| age                           | Возраст                                      | int        | Не обязательное |                                                                  |
| teamId                        | Команда                                      | int        | Не обязательное | ссылается на [`Команды`](#команды)                               |
| createdByManagerId            | Создано менеджером                           | int        | Обязательное    | ссылается на [`Менеджеры`](#менеджеры)                           |
| lastChangedByManagerId        | Изменено менеджером                          | int        | Не обязательное | ссылается на [`Менеджеры`](#менеджеры)                           |
| parentId                      | Родитель                                     | int        | Не обязательное | ссылается на [`Родители`](#родители)                             |
| linkToProfile                 | Ссылка на профиль                            | string     | Не обязательное |                                                                  |
| playerRating                  | Рейтинг за все время                         | int        | Не обязательное |                                                                  |
| photoId                       | Фото игрока                                  | int        | Не обязательное | ссылается на [`Файлы`](#файлы)                                   |
| playerRatingAverage           | Средний рейтинг                              | float      | Не обязательное |                                                                  |
| commonPlayerRatingGoalkeeper  | Общий рейтинг по позиции Goalkeeper          | int        | Не обязательное |                                                                  |
| commonPlayerRatingAttack      | Общий рейтинг по позиции Attack              | int        | Не обязательное |                                                                  |
| commonPlayerRatingMidfielder  | Общий рейтинг по позиции Midfielder          | int        | Не обязательное |                                                                  |
| commonPlayerRatingDefender    | Общий рейтинг по позиции Defender            | int        | Не обязательное |                                                                  |
| playedMatches                 | Количество сыгранных матчей                  | int        | Не обязательное |                                                                  |
| averagePlayerRatingGoalkeeper | Средний рейтинг по позиции Goalkeeper        | float      | Не обязательное |                                                                  |
| averagePlayerRatingAttack     | Средний рейтинг по позиции Attack            | float      | Не обязательное |                                                                  |
| averagePlayerRatingMidfielder | Средний рейтинг игрока по позиции Midfielder | float      | Не обязательное |                                                                  |
| averagePlayerRatingDefender   | Средний рейтинг игрока по позиции Defender   | float      | Не обязательное |                                                                  |
| playerAggregatedRoleId        | Агрегированная позиция                       | string     | Не обязательное | ссылается на [`Агрегированные позиции`](#агрегированные-позиции) |
| playerTag                     | Тэг                                          | string     | Не обязательное |                                                                  |
| progressivePassAccuracy       | Точность прогрессивных передач               | float      | Не обязательное |                                                                  |
| playerRankId                  | Ранг игрока                                  | string     | Не обязательное | ссылается на [`Ранги игроков`](#ранги-игроков)                   |
...
* catalogs.players.title.plural
* catalogs.players.title.singular
* catalogs.players.fields.search
* catalogs.players.fields.firstname
* catalogs.players.fields.lastname
* catalogs.players.fields.patronymic
* catalogs.players.fields.title
* catalogs.players.fields.playerName
* catalogs.players.fields.number
* catalogs.players.fields.dateOfBirth
* catalogs.players.fields.age
* catalogs.players.fields.linkToProfile
* catalogs.players.fields.playerRating
* catalogs.players.fields.playerRatingAverage
* catalogs.players.fields.commonPlayerRatingGoalkeeper
* catalogs.players.fields.commonPlayerRatingAttack
* catalogs.players.fields.commonPlayerRatingMidfielder
* catalogs.players.fields.commonPlayerRatingDefender
* catalogs.players.fields.playedMatches
* catalogs.players.fields.averagePlayerRatingGoalkeeper
* catalogs.players.fields.averagePlayerRatingAttack
* catalogs.players.fields.averagePlayerRatingMidfielder
* catalogs.players.fields.averagePlayerRatingDefender
* catalogs.players.fields.playerTag
* catalogs.players.fields.progressivePassAccuracy

## Отчеты для клубов

`reportForClubs`

Нужен для: Отчеты для клубов
...
| id            | Ид                        | int        | Обязательное    |                                    |
| title         | Название                  | string     | Обязательное    |                                    |
| teamId        | Команда                   | int        | Обязательное    | ссылается на [`Команды`](#команды) |
| competitionId | Турнир                    | int        | Обязательное    | ссылается на [`Турниры`](#турниры) |
| clubId        | Клуб                      | int        | Обязательное    | ссылается на [`Клубы`](#клубы)     |
| lastUpdated   | Дата последнего изменения | date       | Не обязательное |                                    |
| paid          | Оплачен                   | bool       | Не обязательное |                                    |
...
* catalogs.reportForClubs.title.plural
* catalogs.reportForClubs.title.singular
* catalogs.reportForClubs.fields.search
* catalogs.reportForClubs.fields.title
* catalogs.reportForClubs.fields.lastUpdated
* catalogs.reportForClubs.fields.paid

## Отчеты для организаторов

`reportForOrganizations`

Нужен для: Отчеты для организаторов
...
| title         | Название                  | string     | Обязательное    |                                              |
| competitionId | Турнир                    | int        | Обязательное    | ссылается на [`Турниры`](#турниры)           |
| organizatorId | Организатор               | int        | Обязательное    | ссылается на [`Организаторы`](#организаторы) |
| lastUpdated   | Дата последнего изменения | date       | Не обязательное |                                              |
| paid          | Оплачен                   | bool       | Не обязательное |                                              |
...
* catalogs.reportForOrganizations.title.plural
* catalogs.reportForOrganizations.title.singular
* catalogs.reportForOrganizations.fields.search
* catalogs.reportForOrganizations.fields.title
* catalogs.reportForOrganizations.fields.lastUpdated
* catalogs.reportForOrganizations.fields.paid

## Отчеты для родителей

`reportForParents`

Нужен для: Таблица отчетов для родителей
...
| playerId    | Игрок                     | int        | Обязательное    | ссылается на [`Игроки`](#игроки)     |
| matchId     | Матч                      | int        | Обязательное    | ссылается на [`Матчи`](#матчи)       |
| parentId    | Родитель                  | int        | Обязательное    | ссылается на [`Родители`](#родители) |
| lastUpdated | Дата последнего изменения | date       | Не обязательное |                                      |
| paid        | Оплачен                   | bool       | Не обязательное |                                      |
...
* catalogs.reportForParents.title.plural
* catalogs.reportForParents.title.singular
* catalogs.reportForParents.fields.search
* catalogs.reportForParents.fields.title
* catalogs.reportForParents.fields.lastUpdated
* catalogs.reportForParents.fields.paid

## Отчеты для команд

`reportForTeams`

Нужен для: Таблица с отчетами для команд
...
| -------------------- | ------------------------- | ---------- | --------------- | -------------------------------------------------------- |
| id                   | Ид                        | int        | Обязательное    |                                                          |
| created              | Дата и время создания     | datetime   | Обязательное    |                                                          |
| title                | Название                  | string     | Обязательное    |                                                          |
| teamForCompetitionId | Команда на турнире        | int        | Обязательное    | ссылается на [`Команды на турнире`](#команды-на-турнире) |
| matchId              | Матч                      | int        | Обязательное    | ссылается на [`Матчи`](#матчи)                           |
| clubId               | Клуб                      | int        | Обязательное    | ссылается на [`Клубы`](#клубы)                           |
| lastUpdated          | Дата последнего изменения | date       | Не обязательное |                                                          |
| paid                 | Оплачен                   | bool       | Не обязательное |                                                          |
| fileId               | Файл отчета               | int        | Не обязательное | ссылается на [`Файлы`](#файлы)                           |
| htmlFileId           | HTML файл отчета          | int        | Не обязательное | ссылается на [`Файлы`](#файлы)                           |
| jsonFileId           | JSON файл отчета          | int        | Не обязательное | ссылается на [`Файлы`](#файлы)                           |
| needRecalculate      | Требуется пересчет        | bool       | Не обязательное |                                                          |
...
* catalogs.reportForTeams.title.plural
* catalogs.reportForTeams.title.singular
* catalogs.reportForTeams.fields.search
* catalogs.reportForTeams.fields.created
* catalogs.reportForTeams.fields.title
* catalogs.reportForTeams.fields.lastUpdated
* catalogs.reportForTeams.fields.paid
* catalogs.reportForTeams.fields.needRecalculate
...
| --------- | ----------------------- | ----------------- | ------------------- |
| base      | Базовая роль            | false             | false               |
| admin     | Системный администратор | true              | true                |
| manager   | Пользователь            | false             | false               |
| commenter | Комментатор             | false             | false               |
...
Нужен для: Команды на турнире

На сущность ссылаются: [`Заявки на матчи`](#заявки-на-матчи), [`Матчи`](#матчи), [`Списки игроков команд на турнире `](#списки-игроков-команд-на-турнире-), [`Отчеты для команд`](#отчеты-для-команд), [`Составы команд на матчи`](#составы-команд-на-матчи), [`События`](#события)

| Имя поля      | Наименование    | Тип данных | Обязательное    | Справочник                         |
| ------------- | --------------- | ---------- | --------------- | ---------------------------------- |
| id            | Ид              | int        | Обязательное    |                                    |
| title         | Название        | string     | Обязательное    |                                    |
| fullTitle     | Полное название | string     | Не обязательное |                                    |
| teamId        | Команда         | int        | Обязательное    | ссылается на [`Команды`](#команды) |
| competitionId | Турнир          | int        | Обязательное    | ссылается на [`Турниры`](#турниры) |
...
* catalogs.teamForCompetitions.title.plural
* catalogs.teamForCompetitions.title.singular
* catalogs.teamForCompetitions.fields.search
* catalogs.teamForCompetitions.fields.title
* catalogs.teamForCompetitions.fields.fullTitle

## Игроки команд

`teamForPlayers`

Нужен для: Таблица связи игрока с командой
...
* catalogs.teamForPlayers.title.plural
* catalogs.teamForPlayers.title.singular
* catalogs.teamForPlayers.fields.search

## Составы команд на матчи

`teamMatchLists`

Нужен для: Таблица состава команд

На сущность ссылаются: [`Игроки заявки`](#игроки-заявки)
...
* catalogs.teamMatchLists.title.plural
* catalogs.teamMatchLists.title.singular
* catalogs.teamMatchLists.fields.search

## Командные отчеты

`teamMatchReports`

Нужен для: Командный отчет
...
* catalogs.teamMatchReports.title.plural
* catalogs.teamMatchReports.title.singular
* catalogs.teamMatchReports.fields.search
* catalogs.teamMatchReports.fields.created
* catalogs.teamMatchReports.fields.lastUpdated
* catalogs.teamMatchReports.fields.needRecalculate

## Команды

`teams`

Нужен для: Таблица команд

На сущность ссылаются: [`Игроки`](#игроки), [`Отчеты для клубов`](#отчеты-для-клубов), [`Команды на турнире`](#команды-на-турнире), [`Игроки команд`](#игроки-команд)

| Имя поля               | Наименование        | Тип данных | Обязательное    | Справочник                             |
| ---------------------- | ------------------- | ---------- | --------------- | -------------------------------------- |
| id                     | Ид                  | int        | Обязательное    |                                        |
| title                  | Название            | string     | Обязательное    |                                        |
| dateOfBirthFrom        | Год рождения с      | int        | Обязательное    |                                        |
| dateOfBirthTo          | По год рождения     | int        | Не обязательное |                                        |
| createdByManagerId     | Создано менеджером  | int        | Обязательное    | ссылается на [`Менеджеры`](#менеджеры) |
| lastChangedByManagerId | Изменено менеджером | int        | Не обязательное | ссылается на [`Менеджеры`](#менеджеры) |
| clubId                 | Клуб                | int        | Обязательное    | ссылается на [`Клубы`](#клубы)         |
| fileId                 | Логотип команды     | int        | Не обязательное | ссылается на [`Файлы`](#файлы)         |
...
* catalogs.teams.title.plural
* catalogs.teams.title.singular
* catalogs.teams.fields.search
* catalogs.teams.fields.title
* catalogs.teams.fields.dateOfBirthFrom
* catalogs.teams.fields.dateOfBirthTo
...
На сущность ссылаются: [`WSC Messages`](#wsc-messages)

| Имя поля    | Наименование | Тип данных | Обязательное | Справочник                             |
| ----------- | ------------ | ---------- | ------------ | -------------------------------------- |
| id          | Ид           | int        | Обязательное |                                        |
| name        | Name         | string     | Обязательное |                                        |
| phoneNumber | Phone number | string     | Обязательное |                                        |
| wscUserId   | User         | int        | Обязательное | ссылается на [`WSC Users`](#wsc-users) |

### Ограничения уникальности

* `name`, `phoneNumber`, `wscUserId`
...
* catalogs.wscContacts.title.plural
* catalogs.wscContacts.title.singular
* catalogs.wscContacts.fields.search
* catalogs.wscContacts.fields.name
* catalogs.wscContacts.fields.phoneNumber
...
| ------------ | ------------ | ---------- | ------------ | -------------------------------------------- |
| id           | Ид           | int        | Обязательное |                                              |
| externalId   | External id  | string     | Обязательное |                                              |
| dateTimeRaw  | Datetime raw | string     | Обязательное |                                              |
| sender       | Sender       | string     | Обязательное |                                              |
| content      | Content      | string     | Обязательное |                                              |
| wscUserId    | User         | int        | Обязательное | ссылается на [`WSC Users`](#wsc-users)       |
| wscContactId | Contact      | int        | Обязательное | ссылается на [`WSC Contacts`](#wsc-contacts) |
...
* catalogs.wscMessages.title.plural
* catalogs.wscMessages.title.singular
* catalogs.wscMessages.fields.search
* catalogs.wscMessages.fields.externalId
* catalogs.wscMessages.fields.dateTimeRaw
* catalogs.wscMessages.fields.sender
* catalogs.wscMessages.fields.content

## WSC Users

`wscUsers`

На сущность ссылаются: [`WSC Contacts`](#wsc-contacts), [`WSC Messages`](#wsc-messages)

| Имя поля     | Наименование  | Тип данных | Обязательное    | Справочник |
| ------------ | ------------- | ---------- | --------------- | ---------- |
| id           | Ид            | int        | Обязательное    |            |
| login        | Login         | string     | Обязательное    |            |
| passwordHash | Password hash | string     | Обязательное    |            |
| accessToken  | Access token  | string     | Не обязательное |            |
...
* catalogs.wscUsers.title.plural
* catalogs.wscUsers.title.singular
* catalogs.wscUsers.fields.search
* catalogs.wscUsers.fields.login
* catalogs.wscUsers.fields.passwordHash
* catalogs.wscUsers.fields.accessToken
...
| id                      | Ид                                  | int        | Обязательное    |                                                          |
| date                    | Дата                                | datetime   | Обязательное    |                                                          |
| timeSecond              | Временная точка на видео в секундах | int        | Не обязательное |                                                          |
| linkToTimeSecond        | Ссылка к видео                      | string     | Не обязательное |                                                          |
| controversialPoint      | Спорный момент                      | bool       | Не обязательное |                                                          |
| startControversialPoint | Начало спорного момента             | int        | Не обязательное |                                                          |
| highlight               | Интересный момент                   | bool       | Не обязательное |                                                          |
| startHighlight          | Начало интересного момента          | int        | Не обязательное |                                                          |
| order                   | Порядок события                     | int        | Обязательное    |                                                          |
| eventTypeId             | Тип события                         | string     | Обязательное    | ссылается на [`Типы событий`](#типы-событий)             |
| videoId                 | Видео                               | int        | Не обязательное | ссылается на [`Видео матчей`](#видео-матчей)             |
| teamForCompetitionId    | Команда                             | int        | Не обязательное | ссылается на [`Команды на турнире`](#команды-на-турнире) |
| mainPlayerId            | Игрок                               | int        | Не обязательное | ссылается на [`Игроки`](#игроки)                         |
| secondPlayerId          | Игрок 2                             | int        | Не обязательное | ссылается на [`Игроки`](#игроки)                         |
| firstPlayerRoleId       | Амплуа 1 игрока                     | string     | Не обязательное | ссылается на [`Роли игроков`](#роли-игроков)             |
| secondPlayerRoleId      | Амплуа 2 игрока                     | string     | Не обязательное | ссылается на [`Роли игроков`](#роли-игроков)             |
| periodTypeId            | Тип периода                         | string     | Не обязательное | ссылается на [`Типы периодов`](#типы-периодов)           |
| matchId                 | Матч                                | int        | Обязательное    | ссылается на [`Матчи`](#матчи)                           |
| points                  | Баллы                               | int        | Обязательное    |                                                          |
| periodNumber            | Номер периода                       | int        | Не обязательное |                                                          |
...
* catalogs.events.title.plural
* catalogs.events.title.singular
* documents.events.fields.date
* documents.events.fields.search
* documents.events.fields.timeSecond
* documents.events.fields.linkToTimeSecond
* documents.events.fields.controversialPoint
* documents.events.fields.startControversialPoint
* documents.events.fields.highlight
* documents.events.fields.startHighlight
* documents.events.fields.order
* documents.events.fields.points
* documents.events.fields.periodNumber
